...
#include "NoteraWaitGameplayEvent.generated.h"

/**
 * Nothing fancy, just a simple wrapper for UAbilityAsync_WaitGameplayEvent
 */
UCLASS(Category = "Notera")
class NOTERA_API UNoteraWaitGameplayEvent : public UAbilityAsync_WaitGameplayEvent
{
	GENERATED_BODY()
public:
	/**
	...
	static UNoteraWaitGameplayEvent* WaitGameplayEventToActorProxy(AActor* TargetActor, UPARAM(meta=(GameplayTagFilter="GameplayEventTagsCategory")) FGameplayTag EventTag, bool OnlyTriggerOnce = false, bool OnlyMatchExact = true);
