...
ANoteraCharacter::ANoteraCharacter()
{
...
void ANoteraCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ANoteraCharacter::Move);
		EnhancedInputComponent->BindAction(MouseLookAction, ETriggerEvent::Triggered, this, &ANoteraCharacter::Look);
...
void ANoteraCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANoteraCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ANoteraCharacter::DoLook(float Yaw, float Pitch)
{
	if (GetController() != nullptr)
	{
...
void ANoteraCharacter::DoJumpStart()
{
	// signal the character to jump
	Jump();
}

void ANoteraCharacter::DoJumpEnd()
{
