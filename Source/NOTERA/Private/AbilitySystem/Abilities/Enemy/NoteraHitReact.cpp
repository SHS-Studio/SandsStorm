...
#include "AbilitySystem/Abilities/Enemy/NoteraHitReact.h"

void UNoteraHitReact::CacheHitDirectionVectors(AActor* Instigator, FVector& OutAvatarForward, FVector& OutToInstigator)
{
